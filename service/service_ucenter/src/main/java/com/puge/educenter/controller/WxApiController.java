...
import com.puge.educenter.utils.ConstantWxUtils;
import com.puge.educenter.utils.HttpClientUtils;
...
public class WxApiController {
    ...
    public String callback(String code, String state) {
        try {
            //获取code值，临时票据，类似于验证码
            //拿着code请求 微信固定的地址，得到两个值 access_token 和 openid
            ...
            if(member == null) {
                ...
                //拿着得到access_token 和 openid，再去请求微信提供固定的地址，获取到扫描人信息
                //访问微信的资源服务器，获取用户信息
